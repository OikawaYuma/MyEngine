/**
* @ file PSOComputeShader
* @ brief ComputeShaderを使うためのPSO設定
...
class PSOComputeShader : public PSOProperty
{
public:
	static PSOComputeShader* GatInstance();

	PSOComputeShader() = default;
	~PSOComputeShader() = default;
	const PSOComputeShader& operator=(const PSOComputeShader&) = delete;
